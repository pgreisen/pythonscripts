...
class translate_rotate:
    ...
    def transform_ligand_coordinates_lists(self,ligand_coordinates,translation_matrix,rotation_matrix):
        transformed_coordinates = []
        for k in ligand_coordinates:
            transformed_coordinates.append( (dot(k,rotation_matrix) + translation_matrix ) )
        return transformed_coordinates
