...
class pdbfile:
    ...
    def get_transformed_coordinates_pdbfile(self, coordinates, pdbfile,t_rmsd_coordinates, rmsd=False):
        t_coordinates = []
        ...
        for line in pdbfile:
            ...
            if tmp_key in coordinates:
                ...
                if(rmsd):
                    t_rmsd_coordinates[tmp_key] = array([float(x), float(y), float(z)])
