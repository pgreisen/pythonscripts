...
class ParametricHelicalBundle:
    ...
    def Generate_Pdbs(self, Nres,num_chain,num_to_output,w,R,orientation,helix_phase,delta_z,output_file_name,chain_name, chain_order):
        ...
        Res_id=[]
        CA_list=[]
        alpha=math.asin(R*w*self.deg_to_rad/d)
        ...
        for t in range(Nres+2):      ## need two extra residues to guide placement of 1st and last residue
            ...
            a0=(w*t+supercoil_phase)*self.deg_to_rad
            ...
            z= R*w*t*self.deg_to_rad/math.tan(alpha +.00000001)-self.R1*sin(alpha)*sin(a1)+delta_z[iter]
