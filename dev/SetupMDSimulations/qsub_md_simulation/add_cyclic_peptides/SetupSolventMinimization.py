...
END
    ...
    def main(self,pdbfile):
        ...
        max_number_residues = self.get_number_of_residues(pdbfile)

        list_template = self.write_parameter_file(max_number_residues)

        self.write_out_parameterfile(list_template)
