...
class get_union:
    ...
    def main(self):
        ...
        title("5' Sort 4 Enrichment Fentanyl/Apixaban")
        scatter(x1,y1,color='red',s=40)
        # xlim([2.6, 3.2])
        # ylim([3, 4])
        xlabel(r"Apixaban log$_{2}$(Sort4/Naive)")
        ylabel(r"Fentanyl log$_{2}$(Sort4/Naive)")
        ...
        title("5' Sort 4 Enrichment Apixaban")
        ...
        title("5' Sort 4 Enrichment Fentanyl")
