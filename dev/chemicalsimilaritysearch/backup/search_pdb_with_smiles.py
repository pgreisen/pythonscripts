...
<description>ResolutionQuery: refine.ls_d_res_high.comparator=between refine.ls_d_res_high.min=0.0 refine.ls_d_res_high.max="""+str(max_resolution)+""" </description>
...
<refine.ls_d_res_high.max>""" +str(max_resolution)+"""</refine.ls_d_res_high.max>
...
<v_sequence.chainLength.max>5</v_sequence.chainLength.max>
