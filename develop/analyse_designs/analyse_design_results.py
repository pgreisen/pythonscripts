...
class AnalysisOfRosettaDocking:
    ...
    def write_statistics(self, number_of_mutations, sc, ife, pstat, rwl, dsasa, ddg_complex):

        stat = open("statistics.dat",'w')

        stat.write("Name \t Mean \t S.D\n")
        
        mn, sd = self.get_statistics( number_of_mutations )
        stat.write("Number of mutations: "+str(mn)+"\t"+str(sd)+'\n')

        mn, sd = self.get_statistics( sc )
        stat.write("SC: "+str(mn)+"\t"+str(sd)+'\n')

        mn, sd = self.get_statistics( ife )
        stat.write("IFE: "+str(mn)+"\t"+str(sd)+'\n')

        mn, sd = self.get_statistics( pstat )
        stat.write("pstat: "+str(mn)+"\t"+str(sd)+'\n')

        mn, sd = self.get_statistics( rwl )
        stat.write("rwl: "+str(mn)+"\t"+str(sd)+'\n')

        mn, sd = self.get_statistics( dsasa )
        stat.write("Dsasa: "+str(mn)+"\t"+str(sd)+'\n')

        mn, sd = self.get_statistics( ddg_complex )
        stat.write("ddG: "+str(mn)+"\t"+str(sd)+'\n')
