...
class TMalignAnalysis:
    ...
    def __init__(self):
        ...
        self.tmscore_threshold = 0.35


    # def set_matrix(self, inputfile):
    ...
    def analyse_data(self):
                ...
                if(tmpline[0] == "REMARK"):
                    ...
                    if(  tmpline[1] == "Aligned" ):
                        ...
                        if( float(tmp_tmscore) >= self.tmscore_threshold ):
                            # print "###",float(tmp_tmscore) <= self.tmscore_threshold, tmp_tmscore, self.tmscore_threshold,datakey
                            self.aligned_pdbs[newkey] = []
                            go = 1
        ...
        #if( datakey == '6lpr' ):
        #    # print datakey,self.aligned_pdbs
        return go
