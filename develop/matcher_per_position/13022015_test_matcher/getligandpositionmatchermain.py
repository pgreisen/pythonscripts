...
getligandpositionmatchermain.py -f tmp/UM_15_W17Y295_1gca_nohet_1_match_1__DE_1.pdb -p newpos.pos -n O1 N1 aro.
...
def main():
    ...
    parser.add_argument("--ncst",type=int,
                        dest="ncst",default=0,help="Constraint file")
    ...
    mp.set_ncst_string(new_positions,input_var.ncst)
