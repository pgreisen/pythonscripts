...
class VerifyNameSeq:
    ...
    def highlight_greaterthan(self, s, columnname="Mismatch"):
        ...
        if s[columnname] != '':
            return ['background-color: red']*self.nr_columns
        else:
            return ['background-color: white']*self.nr_columns
    ...
    def get_report(self,report):
        ...
        self.nr_columns = len(dftot.columns)
        ...
        dftot.to_csv(self.today+"_"+self.name+".csv",index=False)
