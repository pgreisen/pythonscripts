...
class AA_analysis_enevolv:
    ...
    def get_plotly_histogram_per_AA(self, df, value1, value2, name_of_plot1="test1", name_of_plot2="test2"):
        ...
        layout = go.Layout(paper_bgcolor='rgba(0,0,0,0)',showlegend=False, plot_bgcolor='rgba(0,0,0,0)', xaxis=dict(showgrid=False,color='white',showticklabels=False),yaxis=dict(showgrid=False,color='white',showticklabels=False),
                           boxmode='group')
        fig = go.Figure(data=data, layout=layout)
        fig.update_xaxes(showline=True, linecolor='white',zeroline=False)
        fig.update_yaxes(showline=True, linecolor='white',zeroline=False)
