...
class RunPSSM:
    ...
    def ssh_and_execute_script(self, host, username, command):
        ...
        ftp_client.close()
        stdin2, stdout2, stderr2 = client.exec_command("nohup bash ./exe.sh && echo 1 > logfile;", timeout=self.sleep)
        #  && echo 2 > logfile && wait; && '''+self.exe_hhsearch
    ...
    def main(self):
        ...
        #parser.add_argument('--vpc', dest='vpc', help='VPC - virtual private cloud to use for spinning up ec2 instances')
