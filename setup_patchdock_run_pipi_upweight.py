...
def run_patchdock(ligandname,pdbfile,positionfile):
    ...
    exe = "/work/greisen/files/RunPatchdock/make_patchdock_pipi_upweight.pl"

    exe_run = 'perl '+exe+' '+ligandname+' '+pdbfile+' '+ positionfile
    print "we crash sooooooooooooooooooooooooon"
